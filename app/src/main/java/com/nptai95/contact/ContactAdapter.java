...
public class ContactAdapter extends ArrayAdapter<Contact> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            Button call = (Button) convertView.findViewById(R.id.callBut);
            Button sms = (Button) convertView.findViewById(R.id.smsBut);
            Button email = (Button) convertView.findViewById(R.id.emailBut);
            Button detail = (Button) convertView.findViewById(R.id.detailBut);
